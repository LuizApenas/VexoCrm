...
import { ClipboardList, Sparkles, FileText, FileCheck } from "lucide-react";
...
export default function ComercialVexo() {
  ...
  const activeTab = searchParams.get("tab") || "apresentacao";
  ...
  return (
    <PageShell
      ...
      subtitle="Suíte Comercial Integrada: Briefings, Apresentações SPIN Selling, Propostas e Contratos"
    >
      <div className="w-full space-y-6">
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          <TabsContent value="apresentacao" className="mt-0 focus-visible:outline-none">
            <ErrorBoundary>
              <VexoPitch />
            </ErrorBoundary>
          </TabsContent>
