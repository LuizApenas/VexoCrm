...
export function MainLayout() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-transparent px-3 py-3 lg:px-6 lg:py-5">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-1.5rem)] w-full max-w-[1580px] overflow-hidden rounded-[32px] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(242,246,255,0.96))] shadow-[0_35px_120px_rgba(15,23,42,0.12)] ring-1 ring-slate-200/60 dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(10,12,40,0.9),rgba(5,6,28,0.96))] dark:shadow-[0_35px_120px_rgba(0,0,0,0.45)] dark:ring-white/5">
        <AppSidebar />
