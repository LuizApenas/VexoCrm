...
export function MainLayout() {
  return (
    <div className="relative h-screen overflow-hidden bg-transparent px-2 py-2 lg:px-3 lg:py-3 print:h-auto print:overflow-visible print:p-0 print:m-0">
